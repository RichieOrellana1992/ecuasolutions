...
<div class="page-content row">
	...
	{!! Form::open(array('url'=>'parroquias?return='.$return, 'class'=>'form-horizontal validated','files' => true )) !!}
	<div class="sbox">
...
<div class="col-md-12">
				...
				{!! Form::hidden('parroquia_id', $row['parroquia_id']) !!}					
									  <div class="form-group  " >
										<label for="Cantón" class=" control-label col-md-4 text-right"> Cantón <span class="asterix"> * </span></label>
										<div class="col-md-6">
										  <select name='canton_id' rows='5' id='canton_id' class='select2 ' required  ></select> 
										 </div> 
										 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("parroquias/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
