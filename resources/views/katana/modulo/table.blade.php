...
<div class="page-content row">
 ...
 {!! Form::open(array('url'=>'katana/modulo/savetable/'.$modulo_nombre, 'class'=>'form-horizontal','id'=>'fTable')) !!}

		@include('katana.modulo.tab',array('active'=>'table','type'=>$type))
	...
	<div class="infobox infobox-success fade in">
	 ...
	 <div class="table-responsive">
			...
			<thead class="no-border">
			  <tr>
				...
				<th scope="col" width="70"> Límite</th>
				<th scope="col"><i class="icon-link"></i></th>
				<th scope="col" data-hide="phone">Título / Caption </th>
				...
				<th scope="col" data-hide="phone" style="width:70px;">Ancho</th>
				<th scope="col" data-hide="phone" style="width:70px;">Alinear</th>
				<th scope="col" data-hide="phone"> Formato </th>
			  </tr>
			 </thead> 
			...
			<?php usort($tables, "SiteHelpers::_sort"); ?>
			  ...
			  <tr >
				...
				<span class=" xlick " title="Lookup Display" 
					onclick="SximoModal('{{ URL::to('katana/modulo/conn/'.$row->modulo_id.'?field='.$rows['field'].'&alias='.$rows['alias']) }}' ,' Campo de Conexión : {{ $rows['field']}} ' )"
					>
	 ...
	 <div class="infobox infobox-info fade in">
	  <button type="button" class="close" data-dismiss="alert"> x </button>  
	   <b> NOTE :  </b> | <b>(DW)</b>  = Descargar | <b> (VD) </b> = Ver detalles | <b>( ST )</b> = Ordenable <br />
	  <p> <strong>Tips !</strong> Arrastra y suelta filas para reordenar listas </p>
	</div>	
					
			<button type="submit" class="btn btn-primary"><i class="icon-checkmark-circle2"></i> Guardar Cambios </button>
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    <?php echo KatanaHelpers::sjForm('fTable'); ?>
