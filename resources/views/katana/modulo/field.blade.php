...
$(document).ready(function(){
	...
	$("#lookup_table").jCombo("{{ URL::to('katana/modulo/combotable') }}" , {
		selected_value : "<?php echo $f['option']['lookup_table'];?>" ,
		initial_text : ' Select Table',
		
	});

	$("#lookup_key").jCombo("{{ URL::to('katana/modulo/combotablefield') }}?table=",
 ...
 {!! Form::open(array('url'=>'katana/modulo/saveformfield/'.$modulo_nombre, 'class'=>'form-horizontal')) !!}
