            ...
            <li><!-- HOME -->
                ...
                @endif
                 ...
                 @if(count($menu['childs']) > 0 ) class="dropdown-toggle" data-toggle="dropdown" @endif>
                    ...
                    @if(config('ktn.cnf_multilang') ==1 && isset($menu['menu_lang']['title'][session('lang')]) && $menu['menu_lang']['title'][session('lang')]!='')
                ...
                @foreach ($menu['childs'] as $menu2)
                    ...
                    <li class="
                        ...
                        >
                            ...
                            @if(config('ktn.cnf_multilang') ==1 && isset($menu2['menu_lang']['title'][session('lang')]))
