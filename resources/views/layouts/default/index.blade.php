...
<meta name="viewport" content="width=device-width, initial-scale=1">
    <title>{{ $title }} | {{ config('ktn.cnf_appname') }}</title>
            ...
            <div class="col-md-6 ">
              <ul class="social-icons pull-right">
               ...
               @else
                ...
                <li><a href="{{ url('/login') }}"><i class="fa fa-lock"></i> {{ __('core.signin') }} </a></li>
        ...
        <div class="container">
          <div class="row text-center">
              ...
              <p class="copyright-text">
                ©  {{ date('Y') }} <b>{{ config('ktn.cnf_comname') }} </b>. All right reserved. Designed with by <a href="#">CrudEngine</a>
              </p>
